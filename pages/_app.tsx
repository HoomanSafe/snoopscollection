    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="A collection of Snoops on the blockchain lighting up the world with love and joy."
        />
        <meta name="description" content="A collection of Snoops on the blockchain lighting up the world with love and joy." />
