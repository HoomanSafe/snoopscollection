    ...
    return (
      <>
        <style jsx global>
          {`
     body {
      background-image: url('https://i.ibb.co/nMQFVVf/beautiful-sky-landscape-digital-art-style.jpg');
      background-size: cover;
      background-position: center;
  }
   `}
        </style>
        <Card background= {"#ff99cc"}>
          <CardHeader>
            <Flex minWidth='max-content' alignItems='center' gap='2'>
              ...
              {loading ? (<></>) : (
                <Flex  justifyContent="flex-end" marginLeft="auto">
                  <Box background={"#a1d58c"} borderRadius={"5px"} minWidth={"50px"} minHeight={"50px"} p={2} >
                    <VStack >
